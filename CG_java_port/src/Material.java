...
public class Material {
	...
	/**
	 * Constructs a material with specified stream.
	 *
	...
	/**
	 * Reads material components from the specified stream to the specified material.
	...
	public static Scanner read(Scanner scn, Value<Material> m) {
		m.setValue(new Material(scn));
		return scn;
	}

	/**
	 * Reads material components from the specified stream to this material.
	 * The specified stream will be reduced.
	 *
	 * @param scn the stream to be read
	 * @return the reduced stream
