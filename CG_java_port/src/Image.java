...
public class Image {
    ...
    public boolean write(String filename) {
        try {
            ...
            outStream.write(0); // abs coordinate lower left display in x at
            outStream.write(0); //
            outStream.write(0); // abs coordinate lower left display in y at
            outStream.write(0); //
            ...
            for (Value<Vec3> color : pixels) {
                outStream.write((char) (255.0 * color.get().get(2)));
                outStream.write((char) (255.0 * color.get().get(1)));
                outStream.write((char) (255.0 * color.get().get(0)));
            }
