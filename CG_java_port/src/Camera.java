...
public class Camera {
    ...
    /**
     * opening angle (field of view) in y-at
     */
    private double fovy;
    ...
    /**
     * Constructs a camera with specified scanner.
     *
     ...
     */
    private void init() {
        // compute viewing at and distance of eye to scene center
    ...
    /**
     * Reads camera components from the specified Scanner to this camera.
     *
     * @param scn the scanner to be read
    ...
    /**
     * Reads camera components from the specified scanner to the specified camera.
     *
     * @param scn the scanner to be read
