...
public class Vec3 {
    ...
    /**
     * Constructs a vector with specified value in all vector components.
     *
     * @param s the value to be used
     */
    ...
    /**
     * Constructs a vector with specified data
     *
     ...
     * Constructs a vector with specified data
     *
     * @param d the data for each vector component. Must be of length >= 3!
     */
    ...
    /**
     * Constructs a vector with specified scanner.
     *
    ...
    /**
     * Returns a pretty String of this vector.
     *
